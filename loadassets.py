...
class LoadAssets:
    ...
    def load_music(self):
        self.mixer.music.load("assets/BGM.wav")
    ...
    def load_sounds(self):
        self.click_sound_swoosh = self.mixer.Sound("assets/swoosh.wav")
        self.click_sound_click = self.mixer.Sound("assets/click.wav")
        self.click_sound_pop = self.mixer.Sound("assets/pop.wav")
        self.click_sound_powerup = self.mixer.Sound("assets/powerup.wav")
        self.click_sound_success = self.mixer.Sound("assets/success.wav")
        self.typing_sound = pygame.mixer.Sound("assets/typing_sound.wav")
